...
class RadiosMap private constructor() {
    ...
    private fun addGTA3Radios() {
        ...
        val radios = arrayOfNulls<Radio>(10)
        radios[0] = Radio(
            game,
            "Head Radio",
        ...
        radios[2] =
            Radio(game, "K-Jah", "https://two66.com/mirrors/index.php?file=GTA-Radio-Stations%2FGTA-III%2FKJAH.mp3")
        radios[3] =
            Radio(game, "Rise FM", "https://two66.com/mirrors/index.php?file=GTA-Radio-Stations%2FGTA-III%2FRISE.mp3")
        radios[4] =
            Radio(game, "Lips 106", "https://two66.com/mirrors/index.php?file=GTA-Radio-Stations%2FGTA-III%2FLIPS.mp3")
        radios[5] = Radio(
            game,
            "Game Radio FM",
        ...
        radios[6] =
            Radio(game, "MSX FM", "https://two66.com/mirrors/index.php?file=GTA-Radio-Stations%2FGTA-III%2FMSX.mp3")
        radios[7] = Radio(
            game,
            "Flashback FM",
    ...
    fun getRadiosOfGame(game: String): Array<String?> {
